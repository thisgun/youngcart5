    ...
    <div class="form_01 new_win_con">
        ...
        <ul>
            ...
            <li>
                ...
                <input type="text" name="iq_email" id="iq_email" value="<?php echo get_text($qa['iq_email']); ?>" class="frm_input" size="30" placeholder="이메일"><br>
                <span class="frm_info">이메일을 입력하시면 답변 등록 시 답변이 이메일로 전송됩니다.</span>
            </li>
            <li>
                <label for="iq_hp" class="sound_only">휴대폰</label>
                <input type="text" name="iq_hp" id="iq_hp" value="<?php echo get_text($qa['iq_hp']); ?>" class="frm_input" size="20" placeholder="휴대폰"><br>
            ...
            <li>
                ...
                <input type="text" name="iq_subject" value="<?php echo get_text($qa['iq_subject']); ?>" id="iq_subject" required class="required frm_input" minlength="2" maxlength="250" placeholder="제목">
            </li>
            <li>
