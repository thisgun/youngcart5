            ...
            <li class="bo_li<?php if ($is_checkbox) echo ' bo_adm'; ?>">
                ...
                <div class="li_title">
                    ...
                    <a href="<?php echo $list[$i]['view_href']; ?>" class="li_sbj">
                        <?php echo $list[$i]['subject']; ?><?php if ($list[$i]['icon_file']) echo " <i class=\"fa fa-download\" aria-hidden=\"true\"></i>" ; ?>
                    </a>
                </div>
                <div class="li_info">
                    ...
                    <span class="date"><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo $list[$i]['date']; ?></span>
